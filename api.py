...
url = f"https://api.open-meteo.com/v1/forecast?latitude=19.07&longitude=72.87&start_date={start_date}&end_date={end_date}&daily=temperature_2m_max,temperature_2m_min"
...
plt.title('Mumbai Weather - Past Week')
plt.legend()
...
df.to_csv('data/mumbai_weather.csv', index=False)
